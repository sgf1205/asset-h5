...
<el-container class="container">
    <el-aside width="auto">
        ...
        <template v-for="v in routes">
            ...
            <el-submenu v-else :key="v.path" :index="v.name">
                ...
                <el-menu-item :index="val.name" :route="{name:val.name}" :key="val.path" v-for="val in v.children"><i class="el-icon-yuan"></i>{{val.meta.title}}</el-menu-item>
            </el-submenu>
        </template>
        </el-menu>
    </el-aside>
  <el-container>
    <el-header>
        ...
        <el-menu menu-trigger="hover" :router="true" class="el-menu-demo" mode="horizontal" >
            <el-submenu index="1">
                <template slot="title">
...
export default {
    ...
    created(){
        this.routes = this.$router.options.routes[1].children.filter(v=>v.hidden==false);
